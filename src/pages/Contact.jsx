...
function Contact() {
  ...
  return (
    <div className="Contact-aurora-wrapper d-flex flex-column align-items-center p-3 p-md-4 pt-5">
      <Container style={{ maxWidth: "1140px", zIndex: 1 }} className="mt-4 mt-md-5">
        <div className="text-center mb-5 pb-3">
          ...
          >
            Để lại lời nhắn hoặc thông tin liên hệ, chúng tôi sẽ phản hồi bạn trong thời gian sớm nhất!
          </p>
        </div>
              ...
              <Card.Body className="p-4 p-lg-5">
                <Form onSubmit={handleSubmit}>
                  <Row className="g-3 mb-3">
                    <Col md={6}>
                      <FloatingLabel controlId="floatingName" label="Họ và tên" className="Contact-floating-label">
                        <Form.Control
                          type="text"
                          name="name"
                    ...
                    <Col md={6}>
                      <FloatingLabel controlId="floatingEmail" label="Email" className="Contact-floating-label">
                        <Form.Control
                          type="email"
                          name="email"
                          placeholder="Email"
                  ...
                  <FloatingLabel controlId="floatingSubject" label="Tiêu đề" className="mb-3 Contact-floating-label">
                    <Form.Control
                      type="text"
                      name="subject"
                      placeholder="Tiêu đề"
                  ...
                  <FloatingLabel controlId="floatingMessage" label="Nội dung lời nhắn" className="mb-4 Contact-floating-label">
                    <Form.Control
                      as="textarea"
                      name="message"
                  ...
                  <Button variant={null} type="submit" disabled={isLoading} className="w-100 Contact-button-pink" size="lg">
                    {isLoading ? (
                      <>
              ...
              <Card className="Contact-card-glass">
                <Card.Body className="p-4 p-lg-5">
                  <div className="d-flex align-items-center mb-4 Contact-info-item">
                    <div className="Contact-info-icon-wrapper me-3"> <TelephoneFill className="fs-5" /> </div>
                    <div>
                  ...
                  <div className="d-flex align-items-center mb-4 Contact-info-item">
                    <div className="Contact-info-icon-wrapper me-3"> <EnvelopeFill className="fs-5" /> </div>
                    <div>
                      <h3 className="Contact-info-heading">Email</h3>
                      <p className="Contact-info-text">info@amazingfood.com</p>
                    </div>
                  </div>
                  <div className="d-flex align-items-center mb-4 Contact-info-item">
                    <div className="Contact-info-icon-wrapper me-3"> <GeoAltFill className="fs-5" /> </div>
                    <div>
                      <h3 className="Contact-info-heading">Địa chỉ</h3>
                      <p className="Contact-info-text">123 Nguyễn Huệ, Quận 1, TP.HCM</p>
                    </div>
                  </div>
                  <div className="d-flex align-items-center Contact-info-item">
                    <div className="Contact-info-icon-wrapper me-3"> <ClockFill className="fs-5" /> </div>
                    <div>
